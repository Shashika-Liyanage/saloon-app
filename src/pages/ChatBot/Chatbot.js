...
const commonQuestions = {
  ...
  "Any special offers?": "Yes, check our website or social media for promotions.",
...
const Chatbot = ({ isOpen, onClose }) => {
  ...
  const sendMessage = () => {
    ...
    setMessages([...messages, userMessage, { text: 'Typing.......', sender: 'bot' }]);
    setInput('');
    setIsLoading(true);

    setTimeout(() => {
      const botResponse = commonQuestions[input] || "I don't understand. Can you tell me more?";
